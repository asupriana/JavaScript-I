...
const lastCar = inventory[inventory.length-1].car_make + inventory[inventory.length-1].car_model;
console.log(lastCar);
...
const BMWAndAudiOnly = JSON.stringify(BMWAndAudi);
console.log(BMWAndAudiOnly);
